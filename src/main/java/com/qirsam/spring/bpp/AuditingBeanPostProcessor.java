...
public class AuditingBeanPostProcessor implements BeanPostProcessor {
    ...
    private final Map<String, Class<?>> auditBeans = new HashMap<>(); //сохраняем метаинформацию о нашем изначальном бине, если у него есть аннотация
    ...
    public Object postProcessAfterInitialization(Object bean, String beanName) throws BeansException {
        Class<?> beanClass = auditBeans.get(beanName); //Проверяем по метаинформации соответствует ли пришедший бин изначальному (т.к. мог прийти прокси с другого afterBPP)
        if (beanClass != null) {
